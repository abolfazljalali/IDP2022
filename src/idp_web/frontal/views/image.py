...
def image_list(request):
    ...
    try:
        ...
        response_data = serializers.serialize('json', retrived_image, fields=('pk', 'file_name','file_type', 'bands'))
...
def image_preview(request, image_id, page_id):
    ...
    try:
        retrived_image = models.Image.objects.get(pk=image_id)
        image_path = pathlib.Path(os.path.join(retrived_image.directory_path, retrived_image.file_name))
